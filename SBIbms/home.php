...
<title>State Bank of India</title>
    <link href="images/SBI_logo.png" rel="icon">
   <link href="images/SBI_logo.png" rel="apple-touch-icon"> 
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/4.5.0/js/bootstrap.min.js"></script>
  ...
  <?php 
 $con = new mysqli('localhost','root','','SBIbms');
...
<nav class="navbar navbar-expand-xl navbar-light bg-light">
	<a href="home.php" class="navbar-brand"><img src="images/SBI_logo.png" width="45" alt="" class="logo-img"><b>State Bank of India</b></a>
      ...
      <section class="light">
		...
		<article class="postcard light blue">
			<a class="postcard__img_link" href="#">
				<img class="postcard__img" src="images/SBI_logo2.jpg" alt="Image Title" />
			</a>
			<div class="postcard__text t-dark">
				<h1 class="postcard__title blue"><a href="#">Welcome to State Bank of India</a></h1>
				
				<div class="postcard__bar"></div>
				<div class="postcard__preview-txt"><b>State Bank of India</b> is India's largest commercial bank and financial services company. It was founded in 1806 as the Bank of Calcutta, and is the oldest commercial bank in the Indian subcontinent. The Corporate Centre is in Mumbai and 17 Local Head Offices and 101 Zonal Offices are located at important cities spread throughout the country.</div>
