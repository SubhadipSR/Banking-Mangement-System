  ...
  <link rel="stylesheet" href="style.scss"/>
   ...
   <body>
      <nav>
         ...
         <div class="logo" >
         <img src="images/SBI_logo.png" width="45" alt="" class="logo-img">
         State Bank of India
         </div>
        <style> 
        .logo-img{
         ...
         <ul>
            <li><a  href="manager_home.php">Customer Details</a></li>
            <li><a href="manager_accounts.php" >Staff Accounts</a></li>
            <li><a href="addnewaccount.php" class="active">New Account Opening</a></li>
...
<meta charset="utf-8">
      <title>State Bank of India</title>
    <link href="assets/images/SBI_logo.png" rel="icon">
   <link href="assets/images/SBI_logo.png" rel="apple-touch-icon">
